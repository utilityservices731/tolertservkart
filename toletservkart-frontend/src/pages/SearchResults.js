...
const SearchResults = () => {
  ...
  // ✅ Read query from URL (so links remain shareable)
  const queryParams = new URLSearchParams(location.search);
  const query = queryParams.get('query') || '';

  // ✅ Read city from Context
    ...
    axios
      .get('http://localhost:5000/api/search', {
        params: {
          query,
          city,
          pincode, // pass pincode too if your backend supports filtering
        },
      })
